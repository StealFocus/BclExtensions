...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace StealFocus.BclExtensions.Security
{
    using System;
    ...
    public class Impersonation : IDisposable
    {
        ...
        public Impersonation()
        {
            ...
            {
                throw new BclExtensionsException("The Principal has not been set on the current thread");
            }

            WindowsIdentity winIdentity = winPrincipal.Identity as WindowsIdentity;
            if (winIdentity == null)
            {
                throw new BclExtensionsException("The Windows Identity was not available");
            }
        ...
        private class MySafeLogonHandle : SafeHandle
        {
            ...
            */
            ...
            /// <summary>
            /// Overrides the is invalid method
            /// </summary>
