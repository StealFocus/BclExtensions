...
namespace StealFocus.BclExtensions.Xml
{
    using System;
    ...
    public static class XmlDocumentExtensions
    {
        ...
        /// </summary>
        /// <param name="xmlDocument">The XML document.</param>
        /// <param name="xpath">The XPath e.g. <![CDATA["/def:MyDocumentElement"]]>.</param>
        /// <param name="namespaces">The namespaces e.g. the key/value pair of <![CDATA["def"]]> and "http://schemas.acme.com/PetShop".</param>
        ...
        public static XmlElement SelectElement(this XmlDocument xmlDocument, string xpath, IDictionary<string, string> namespaces)
        {
            ...
            {
                throw new BclExtensionsException("The selected node was not an XmlElement.");
            }
